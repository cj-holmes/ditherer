...
By default, if a target palette is not supplied, `ditherer` uses a uniform palette made of 64 colours (in RGB steps of 85). This palette does not perform well, but it does give a certain retro-gaming charm.
